...
public class RedisAPI {
	...
	public static void main(String[] args) {
		testPing();
		//print(RedisClient.getRedisClient().getShardedJedis());
		//print(RedisClient.getRedisClient().getJedis());
	}

	private static void testPing() {
		//连接本地的 Redis 服务
		Jedis jedis = new Jedis("10.40.33.11");
	...
	public void KeyApi() {
		// 清空数据
		print("清空库中所有数据：" + redis.select(1));
		print("清空库中所有数据：" + redis.flushDB());
